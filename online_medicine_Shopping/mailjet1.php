  ...
  $body = [
    'Messages' => [
      [
        ...
        'Subject' => "Confirmation mail from Medicine Guide",
        'TextPart' => "My first Mailjet email",
        'HTMLPart' => "<h3>Dear ".$_SESSION['un'].", <p>Thankyou for shopping with us.</p>
        <p> Your products will be delivered to you soon.</p>",
