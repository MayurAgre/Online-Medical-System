...
<header class="logo">
<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1 style="font-weight: bold;">Admin</h1></span> 
...
<img style='height:70px;width:70px;' src="./images/unauthorized-person.png">
