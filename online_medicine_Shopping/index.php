...
<head>
    ...
    <script type="text/javascript">
        function m1(str) {
            ...
            ob.open("GET", "suggestion.php") + str);
            ob.send();

            ob.onreadystatechange = function () {
                if (ob.readyState == 4 && ob.status == 200) {
                    
                    document.getElementById("a").write = ob.responseText;
                }
            }
        }
    </script>
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
                                <li class="nav-item active">
                                    <a class="nav-link" href="/ipminiproject/home.html"><span class="sr-only">(current)</span></a>
                                </li>
                             ...
                             <div class="dorne-signin-btn">
							   ...
							   {
								   ?><a class="nav-link" href="/ipminiproject/home.html">Home <span class="sr-only">(current)</span></a>
								...
								<a class="nav-link" href="category.php">Category</a>
								   ...
								   {
									   ?>
									   <a href="ragister.php">User Signin or Register</a>
								<a class="nav-link" href="/ipminiproject/home.html">Home <span class="sr-only">(current)</span></a>
								<a class="nav-link" href="category.php">Category</a>
...
<form class="form-inline" method="post" action="search_view.php">  
  ...
  <div class="form-group ">
    <input type="text" class="form-control" name= "country" id="country"  placeholder="Type here..." onkeyup="m1(form.search.value)">
    
  </div>
  <!-- Suggestions :  <span id="a" style="font-size: 20px;"></span><br /> -->
